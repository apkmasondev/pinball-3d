  ...
  inari: {
    ...
    rules: {
      pl: [
        ...
        ['Lisi Ogień', 'Po wystrzale jeden bumper miga. Jeśli trafisz go jako pierwszy, dostajesz Skill Shot.'],
      ...
      en: [
        ...
        ['Fox Fire', 'After the launch one jet blinks: make it the first one you hit for the Skill Shot.'],
