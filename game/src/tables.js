...
export const TABLES = {
  tsukimi: {
    ...
    music: { attract: 'attract', main: 'main', multiball: 'multiball', frenzy: 'frenzy', tsukimi: 'tsukimi' },
    songs: ['calm', 'st'],
  ...
  ryujin: {
    ...
    blurb: {
      pl: 'Podwodny pałac morskiego smoka. Jadeitowa rampa, brama Ryūgū-jō, muszle perłowe i wir, który porywa kulkę.',
      en: 'The sea dragon\'s palace beneath the waves. A jade ramp, the gate of Ryūgū-jō, pearl shells and a whirlpool that grips the ball.',
    },
    features: { pl: ['Dragon Multiball', 'Wir Uzumaki', 'Tryb Ryūgū-jō'], en: ['Dragon Multiball', 'Uzumaki Whirlpool', 'Ryūgū-jō mode'] },
    ...
    music: { attract: 'ry_attract', main: 'ry_main', multiball: 'ry_multiball', frenzy: 'ry_whirl', tsukimi: 'ry_palace' },
    songs: ['zen'],
    ...
    cards: {
      pl: [
        ...
        { title: 'PUNKTACJA', sub: 'Pałac Smoczego Króla', lines: [['Jackpot', '300 000+'], ['Super Jackpot', '1 500 000+'], ['Cele przypływu', 'PERŁY + KICKBACK'], ['Dragon Loop', '60 000 ×']] },
      ],
      en: [
        ...
        { title: 'SCORING', sub: 'Palace of the Dragon King', lines: [['Jackpot', '300,000+'], ['Super Jackpot', '1,500,000+'], ['Tide targets', 'PEARLS + KICKBACK'], ['Dragon Loop', '60,000 ×']] },
      ],
    },
    ...
    rules: {
      pl: [
        ...
        ['Dragon Multiball', 'Gdy LOCK świeci, trafiaj w bramę pałacu. Druga zablokowana kulka budzi smoka: multiball z trzema kulkami.'],
        ['Jackpoty', 'W multiballu jackpoty czekają na jadeitowej rampie i obu orbitach. Zbierz wszystkie, a potem Super Jackpot w pałacu.'],
        ['Wir Uzumaki', 'Trafiaj trzy perłowe muszle po lewej. Komplet rozkręca wir na środku stołu, a bumpery i spinner punktują wielokrotnie.'],
        ...
        ['Przypływ', 'Dwa cele na prawej ścianie. Komplet daje dwie perły i zapala kickback, a co trzeci komplet zapala dodatkową kulkę.'],
        ['Koralowa grota', 'Saucer po lewej przyznaje nagrodę-niespodziankę: punkty, kickback, ochronę kulki, a czasem dodatkową kulkę.'],
      ...
      en: [
        ...
        ['Dragon Multiball', 'With LOCK lit, shoot the palace gate. The second locked ball wakes the dragon: a three-ball multiball.'],
        ['Jackpots', 'During multiball jackpots wait on the jade ramp and both orbits. Collect them all, then the Super Jackpot at the palace.'],
        ['Uzumaki Whirlpool', 'Hit the three pearl shells on the left. The set spins up the whirlpool in the middle, and the bumpers and spinner score many times over.'],
        ...
        ['High tide', 'Two targets on the right wall. The pair adds two pearls and lights the kickback; every third pair lights an extra ball.'],
        ['Coral cave', 'The saucer on the left gives a mystery award: points, kickback, ball save and sometimes an extra ball.'],
